...
class HydrateHandler:
    ...
    async def process_hydrate_redeem(self, channel):
        try:
            sound_thread = Thread(
            ...
            await self.send_companion_event('reaction', {'type': 'hydrate', 'intensity': 1.2})
        except Exception as e:
            logging.error(f"Error in hydrate redeem: {e}")