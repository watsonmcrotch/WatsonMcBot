...
class NewsreelHandler:
    def __init__(self, db_manager, send_companion_event):
        ...
        self.tts_output = str(BASE_DIR / 'sounds' / 'newsreel.mp3')
        self.background_music = str(BASE_DIR / 'sounds' / 'radiobg.mp3')
    ...
    async def process_newsreel_redeem(self, channel, username: str, story_text: str):
        try:
            ...
            if await self.generate_tts(story_text):
                ...
                bg_music_duration = tts_duration + 7000
                fade_out_duration = 4000

                async def play_newsreel_with_bg():
                    try:
                ...
                await self.tts_queue.add_tts(f"newsreel_{username}", play_newsreel_with_bg)
