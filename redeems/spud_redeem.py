...
class SpudHandler:
    def __init__(self, send_companion_event):
        ...
        self.video_path = "assets/videos/spud.webm"

        self.screen_width = 1920
        self.screen_height = 1080
        
        self.original_width = 1080
        self.original_height = 1920
    ...
    async def trigger_companion_event(self):
        ...
        await self.send_companion_event('reaction', {'type': 'spud', 'intensity': 1.2})

    async def process_spud_redeem(self, channel):
        try:
            ...
            logging.error(f"Error in spud redeem: {e}")